...
def init_configs() -> BasicConfig:
    ...
    elif configs.dataset_name.startswith('wifi_ar'):
        configs.datasource_path = os.path.join(args.datasource_path, 'wifi_ar')
    elif configs.dataset_name.startswith('hthi'):
        configs.datasource_path = os.path.join(args.datasource_path, 'hthi')
    elif configs.dataset_name.startswith('harlnl'):
        configs.datasource_path = os.path.join(args.datasource_path, 'harlnl')
