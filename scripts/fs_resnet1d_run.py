...
if __name__ == '__main__':
    ...
    model_list = [
        ('fs_resnet1d_101', 'fs_resnet1d_span_cls', 16),

        ('fs_resnet1d_50', 'fs_resnet1d_span_cls', 16),

        ('fs_resnet1d_34', 'fs_resnet1d_span_cls', 16),

        ('fs_resnet1d_18', 'fs_resnet1d_span_cls', 16),
    ]
