...
if __name__ == '__main__':
    ...
    model_list = [
        ...
        ('ds_vit_ms_16_2_early', 'ds_vit_span_cls', 64),
        ('ds_vit_ms_16_2_late', 'ds_vit_span_cls', 64),
        ('ds_vit_ms_16_2_fully', 'ds_vit_span_cls', 64),

        ('ds_vit_es_16_2_early', 'ds_vit_span_cls', 64),
        ('ds_vit_es_16_2_late', 'ds_vit_span_cls', 64),
        ('ds_vit_es_16_2_fully', 'ds_vit_span_cls', 64),
    ]
